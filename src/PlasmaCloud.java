 ...
 * Also used to generate random terrain where "color" becomes the altitude.
 *
 * See: http://introcs.cs.princeton.edu/java/23recursion/
 */
public class PlasmaCloud {

    // centered at (x, y), of given size, using given standard deviation for computing the displacement, and with upper left,
